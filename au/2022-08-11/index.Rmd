---
# For NCRR
title: "How (and why) to become more reproducible and open in your research"
...
.footer-left[
Slides: [slides.lwjohnst.com/au/2022-08-11](https://slides.lwjohnst.com/au/2022-08-11/)  
...
2. Hear and learn how others in your group work and on their experiences and thoughts

--

3. Learn about some simple ways you can become more open and reproducible in your work

--

4. Identify actionable ways to adopt some of these practices in your group at NCRR (1)
...
- It's like baking: Data are the ingredients and the analysis is the recipe
- Known as analytic/computational reproducibility or reproducible data analysis.
- *Independently* reproduce results in paper based on same analysis and data.

---

## Reproducibility is a spectrum: *Any* improvement is better than no improvement
...
research. As you think of what you do, write them down on the stickies, until the time runs out.
...
## Reproducibility as a spectrum: *Any* improvement is better than no improvement
...
\+ Use relative file paths (`data/project-data.csv` vs `C:/User1/some-data-file.csv`)  
...
in your research group and/or individual level (from the trainee to those more
established)?
...
in your research group and/or individual level (from knowledge and technical
capacity, to what gets supported and what doesn't)?

- For 1 min, *to yourself*, think about the question.

- For 2 min, discuss with a different neighbour what you've thought about.
...
- Agreeing to all write and publish protocols with analysis plans for projects
]
    
--

.pull-left[
- Decide on a standard folder and file structure for each project/manuscript for your
group

- Have frequent informal "lightning round" of code/skill sharing
...
> What are some potential options that you and your research group could
implement ***relatively easily and within the short-term (<6 months)*** to be more
open and reproducible?

- For 2 min, think about ideas to this question (and write down if you want to on the stickies)

- For 3 min, brainstorm with in your group (I'll make them) on what you've all thought about

- For 2 min, decide on one person to write down some of the ideas on the sheet of paper
...
> What are some potential options that you and your research group could implement
that are ***more difficult and within the longer-term (>1 year)*** to be more open
and reproducible?

- For 2 min, think about ideas to this question (and write down if you want to on the stickies)

- For 3 min, brainstorm with your group (I'll make them) on what you've all thought about
