...
knitr::include_graphics("images/spectrum-reproducibility.svg")
```
...
research. As you think of them, add them to the Mentimeter, until the time runs.
...
knitr::include_graphics("images/spectrum-open-science.svg")
```
