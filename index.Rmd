...
-   **June 17, 2025**: [*(Non-) Reproducibility: Or, what are we even
    doing? And how can we improve?*](s/2025-06-17/index.html) talk for
    the Neurobiology Research Unit at Rigshospitalet, Copenhagen
    University Hospital, Copenhagen, Denmark

-   **April 10, 2025**: [*Integrating open and reproducible practices
    within a research organization*](s/2025-04-10/index.html) talk for
    the Danish Reproducibility Network at the Pioneer Centre for AI at
    University of Copenhagen, Denmark.

-   **May 23, 2024**: [*Building a culture that uses open knowledge
    management for effective collaboration and open
    research*](s/2024-05-23/index.html) talk (done by Daniel Ibsen in my
    place) for Steno Aarhus Research Retreat.

-   **April 04, 2024**: [*Modern, fast, and powerful approaches to
    working with data on Denmark Statistics*](s/2024-04-04/index.html)
    talk to the Register Space session at Steno Diabetes Center Aarhus,
    Denmark.

-   **December 04, 2023**: [*Research Operations 'Space': Improving and
    streamlining the entire research
    lifecycle*](s/2023-12-04/index.html) talk for the Steno Diabetes
    Center Epidemiology Group at the Annual Meeting in Aarhus, Denmark.

-   **October 26, 2023**: [*Open Science in Health: Practical
    perspectives and actions toward openness*](s/2023-10-26/index.html)
    talk for CNAP Annual Seminar in Aalborg, Denmark

-   **September 13, 2023**: [*The forgotten child in research: Data
    engineering and infrastructure*](s/2023-09-13/index.html) talk for
    BioMedical Design Fellowship Programme in Aarhus, Denmark

-   **March 31, 2023**: [*Working towards research that is more
    reproducible and open*](s/2023-03-31/index.html) talk for McGill
    School of Human Nutrition Coding Club: Reproducible Research
    (virtual)
