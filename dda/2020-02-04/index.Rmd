...
- How metabolic processes mediate link? `r emo::ji("shrug")``r emo::ji("shrug")`
...
## Analyzing data that looks like:
...
- Potential for other research `r fa2("question")`s
    - Cohort `r fa2("link")` with registers
    - Application of causal learning algorithm

- Gain expertise in working with registers

- Potential to get `r fa2("dollar-sign")``r fa2("dollar-sign")` to expand project
