...
<div class="my-header">
`r lwj::qrencode_svg("https://slides.lwjohnst.com/dda/2020-02-06/")`
</div> 
...
# mono_dark(
#     base_color = "#214c78",
#     black_color = darken_color("#214c78", 0.75),
#     header_color = "#ffdebd", 
#     text_color = "#ffdebd", 
#     text_font_size = "36px",
...
.center[![Reducing number of variables with PCA](images/pca.png)]
...
```{r network-analysis, echo=FALSE, fig.width=7, fig.height=5, message=FALSE, warning=FALSE, fig.align="center"}
set.seed(126)
...
knitr::include_graphics("images/nc-step-1.png")
```
...
knitr::include_graphics("images/nc-step-2.png")
```
...
```{r, out.width="65%", fig.align="center"}
knitr::include_graphics("images/nc-step-3.png")
```
...
```{r, out.width="65%", fig.align="center"}
knitr::include_graphics("images/nc-step-4.png")
```
...
```{r, out.width="65%", fig.align="center"}
knitr::include_graphics("images/nc-step-5.png")
```
...
```{r, out.width="65%", fig.align="center"}
knitr::include_graphics("images/nc-step-6.png")
```
...
```{r, out.width="65%", fig.align="center"}
knitr::include_graphics("images/nc-step-7.png")
```
...
knitr::include_graphics("images/nc-step-8.png")
```
...
```{r, out.width="85%", fig.align="center"}
knitr::include_graphics("images/nc-causal-pathways.png")
```
