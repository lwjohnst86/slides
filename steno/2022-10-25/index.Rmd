...
## Discussion time (~6 min): How can engineering help?

> Talk with neighbour: How do **you** think data and software engineering can help?
...
2. Use consistent and descriptive variable names, example:

    ``` text
    glucose_0min, glucose_30min, family_history_t2dm, gender, birth_year
    ```

3. Include a metadata file, example:
...
## Practical ways of sharing data
