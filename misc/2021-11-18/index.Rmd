...
5. Limit lectures and slides (largely used for conceptual/ranting topics)
...
.footnote[Website: From Hugo Academic (blogdown) to GitBook (bookdown) to Bootstrap (bookdown) theme.]
...
When I started I used a typical style website format, like that offered by the
Hugo Academic theme, but there were several things that bugged me about it,
especially around ease of use. Which was important because I wanted more contributors
and collaborators working on this project. So I moved over to using bookdown,
which is an R package for making books.

I think book formats for a structure of a course works very well, 
because courses are chronological and time is linear,
and since books are linear as well, the content follows exactly what we cover.
...
and maintaining an environment that is safe and supportive for learning. Having that
explicit description of expected behaviour of learners and instructors through
the code of conduct, through the syllabus, through how you as the instructor embody
this attitude. Learning is more than just the teaching and the content, but also
about the learners motivation and interest and engagement with the content...
and if the environment doesn't feel safe for them, they won't learn as much as they
could.

And it's so easy to unconsciously use dismissive or diminishing language like "just" or
"simply" or hand-waving something away when talking about something while you're
teaching... but that can lead to undermining learners confidence and trust,
particularly for underrepresented or minority groups within science.

For instance, what I do is have a question in the pre-course survey asking
if they have read the code of conduct, which is also a pre-course task of
theirs. Then during the first introduction session, I mention that I saw
everyone say yes to it so I make it clear, this is important, this isn't
something on the side. Its a key component to the whole learning environment and
process.

And having this environment also means we engage more of them in getting involved
as teachers or contributors. Which then solidifies the learning even more.
