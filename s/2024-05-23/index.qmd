...
::: notes
Tim Gowers, a mathematician from Cambridge University and a recipient of
the Fields Medal, also known as the Nobel Prize of math, tried to do
something different in January 2009.

He was working on an important and unresolved math problem. One that no
one has ever been able to solve.

He already had a blog and now he tried to solve the problem in the open
and asked anyone to help him solve the problem.

In the first 7 hours, nothing happened. But then, a mathematician named
Jozsef Solymosi from the University of British Colombia posted a comment
with a suggestion to solve the problem. Minutes later, a high-school
teacher from Arizona gave his suggestion. Just after that, Terence Tao,
another Fields Medal recipient, chimed in.

The ball had started rolling.

Over the next 37 days, 27 people wrote 800 comments, with more than
170,000 words.

Just 37 days after the project started, the problem was solved.
:::

## Reinventing discovery {.center}

By using online **open collaboration**, they solved a complex unsolved
problem.

A shift in research practice (=a shift in culture), solved what was
thought unsolvable - in record time!

## What worked well in this project {.center}
...
::: notes
Collective intelligence: knowledge has now been decentralized. We are
many great minds in specific domains.

Division of labour: who does what? clear division is import. Have the
right person do the right job.

Modularizing: 2 thing, 1) small concrete tasks (for the right person),
2) modularizing is also an effective way of building something big -
think of LEGO

Critical mass: needs to be enough to keep the discussion going

Restructuring attention: complex projects have many places to look.
There needs to be a system for this.
:::

## The problems we solve are getting bigger and bigger, and more and more complex {.center}

Getting a good life with diabetes and preventing diabetes are complex
problems

. . .

More and more people are needed to solve the problem. Bigger and bigger
organizations are needed.

. . .

To solve the complex problems we need to change/update our research
culture

::: notes
The methods we have previously used may not be effective to solve the
big societal problems we face today.

Changing the way we work, our research culture, may move us faster in
the right direction.

Note: SDCA is also getting bigger.
:::

# Culture is social learning

Culture = *"the process of socially learning a group's knowledge,
rituals, and behaviours over time when they are part of or exposed to
that group."*
...
::: notes
This leads us to knowledge management? What is it and what can make it
be open?

This is also a tool to amplify our collective intelligence.
:::
...
than what we intuitively and instinctively will do.
:::
...
It includes, increasingly, technological methods, like using wikis,
posts on websites, document sharing tools, and general IT infrastructure
to help store and retrieve knowledge.
...
general sharing through publications and conferences.

But we're not as good at sharing knowledge within organizations and
groups in a more formal, written, and structured way, as this often
requires a greater need for organizational and technological support to
be effective.
:::
...
::: notes
Knowledge management is well known and used within industry to help
ensure that companies maintain a competitive advantage in the market.

In academia and research, it isn't as commonly used, even though it can
help improve collaboration and innovation because of the increased
sharing of knowledge and solving complex problems.
:::
...
::: notes
Because researchers move around quite a bit, a lot of internal knowledge
can get lost when there isn't a formal knowledge system in place. By
using a knowledge management system, we can keep more of that knowledge
gained from the movement of researchers. More knowledge retained means
there are more chances for innovative ideas to be created *and* further
developed, faster than would otherwise be the case. Like, it is easier
to collaborate when we can make use of shared resources and knowledge.
:::
...
::: notes
Likewise, when there are less researchers doing something, there is less
knowledge on that topic and it makes it harder to do. Science is
incredibly hard to do well, and doing open science can make it harder
because it is still relatively new and few researchers actually practice
it.

So by sharing more variety of knowledge than the traditional publication
output, sharing more widely internally in formal systems, we can learn
and improve faster than we would otherwise.
:::

## Like any investment, it takes time but pays off in the long run {.center}

::: notes
And like anything, it is an investment that takes some to do and setup,
but pays off very well in the future. For individual researchers at any
given point in time, the pay off isn't as tangible or strong, but as an
organization, or as a group, the return on investment can be quite
substantial and seen much faster than at the individual level.
:::
...
::: notes
There are many technological tools available to help with knowledge
management, though most of them are designed with a corporate setting in
mind.

However, there are a few, non-technological, principles to follow to
start implementing a formal knowledge management system.

> *Note*: These principles can be listed or expanded on as desired.
:::
...
::: notes
An example of one such system that we are doing in Steno is the Common
Docs, where we've been increasingly moving documentation and other
resources to a central location to make it easier to find and share
knowledge.
:::

## Activity: Think :thinking: pair :speech_balloon: share :loudspeaker: {.smaller}
...
> find later? Is it easy for others to find and use?

1.  2 min: Think about these questions and, if you want, write down
    thoughts
...
> does Steno or the group. I think a big part of this presentation is
> getting them to think and discuss the topic.

Time for an activity! We'll do a think-pair-share, where we'll think
about and discuss these questions. First, you'll have a couple of
minutes to read these questions, then some time to share and discuss
with your neighbour, and lastly, we'll discuss all as a group.
:::
...
::: notes
Seedcase: Develop software and teaching resources to make it easier to
build, manage, share, find, and get data.
:::
...
-   [Reinventing Discovery by Michael
    Nielsen](https://www.amazon.com/Reinventing-Discovery-New-Networked-Science/dp/0691160198)
